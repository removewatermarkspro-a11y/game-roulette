    ...
    <>
      ...
      <section className="hero">
          ...
          <div className="float-card-inner">
            ...
            <div className="float-card-author">
              ...
              <div>
                ...
                <div className="float-card-role">Pizza Roma</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="hero-float-card hero-float-right">
          <div className="float-card-inner float-card-stats">
            <div className="float-stats-header">
              <div className="float-stats-icon">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none"><path d="M12 2L15.09 8.26L22 9.27L17 14.14L18.18 21.02L12 17.77L5.82 21.02L7 14.14L2 9.27L8.91 8.26L12 2Z" fill="#FBBC04" /></svg>
              </div>
              <span className="float-stats-label">Note Google</span>
            </div>
            <div className="float-stats-value">
              <span className="float-stats-number">4.9</span>
              <span className="float-stats-unit">/5</span>
              <span className="float-stats-badge">+0.8 ↑</span>
            </div>
            <div className="float-stats-bar-container">
              <div className="float-stats-bar" />
            </div>
            <div className="float-stats-row">
              <div className="float-stats-mini">
                <span className="float-stats-mini-value">+230</span>
                <span className="float-stats-mini-label">avis</span>
              </div>
              <div className="float-stats-mini">
                <span className="float-stats-mini-value">92%</span>
                <span className="float-stats-mini-label">jouent</span>
              </div>
            </div>
          </div>
        </div>
